...
interface PlaceAnalyticsProps {
  places: AnalyticsData["places"];
}

export default function PlaceAnalytics({ places }: PlaceAnalyticsProps) {
  return (
    <div className="bg-white/90 shadow rounded-xl p-5 border border-purple-200">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="text-center p-3 bg-primary-50 rounded-lg">
          ...
          <p className="text-2xl font-bold text-primary-600">{places.total}</p>
        </div>
        ...
        <div className="text-center p-3 bg-secondary-50 rounded-lg">
          <p className="text-sm text-gray-600">عدد المراجعات</p>
          <p className="text-2xl font-bold text-secondary-600">{places.reviews_count}</p>
        </div>
      </div>
